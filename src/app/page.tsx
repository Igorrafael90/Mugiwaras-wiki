  ...
  return (
    <main className="grid grid-cols-1 w-full">
      ...
      <section className="w-full max-w-5xl mx-auto px-6 grid grid-cols-3 gap-8 mt-9">
            {trips.map((trip) => (
              <div key={trip.Name} className="bg-gray-600 h-80 rounded-md p-8 border-gray-600 border shadow-black shadow-lg hover:scale-110 hover:-translate-y-4 hover:border-red-500">
